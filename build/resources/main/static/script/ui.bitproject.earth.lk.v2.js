...
function selectRow(tableid,rowno,active){
        ...
        var rows = tableid.children[1].children;
           if(rows[rowno-1]!=null) rows[rowno-1].style.background=active;
...
function fillCombo(combo,message,list,attribute,selectedvalue,attribute2=null) {
    ...
    for (index in  list) {
        ...
        var text = document.createTextNode(list[index][attribute]);
            ...
            var text = document.createTextNode(list[index][attribute][attribute2]);
